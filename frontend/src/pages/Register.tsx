...
import { TermsAndConditions } from "@/components/auth/TermsAndConditons";
...
const Register = () => {
  ...
  // Handle terms acceptance for service provider
  const handleTermsAccepted = () => {
    ...
    // Register the basic provider account
    try {
      ...
      setTimeout(() => {
        ...
        // Updated to use the new public route for provider approval setup
